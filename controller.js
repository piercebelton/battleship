$(document).ready(function() {
  ...
  placeShipOfLength(5);
  placeShipOfLengthAndOrientation(4, true);
  placeShipOfLengthAndOrientation(4, false);
  placeShipOfLengthAndOrientation(3, true);
  placeShipOfLengthAndOrientation(3, false);
  placeShipOfLengthAndOrientation(2, true);
  placeShipOfLengthAndOrientation(2, false);
  placeShipOfLength(1);
